! function(t) {
    t.fn.unveil = function(e, i) {
        function n() {
            ...
            o = e.trigger("unveil"), h = h.not(o)
        }
        var o, r = t(window),
            s = e || 0,
            a = window.devicePixelRatio > 1,
            u = a ? "data-src-retina" : "data-src",
            h = this;
...
function(t, e) {
    ...
    function r(e) {
        if (o(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
            ...
            for (var d = a.isBorderBox = "border-box" == r.boxSizing, c = 0; c < h; c++) {
                var l = u[c],
                    f = r[l],
                    p = parseFloat(f);
                a[l] = isNaN(p) ? 0 : p
            ...
            var m = a.paddingLeft + a.paddingRight,
                ...
                z = d && s,
                E = t(r.width);
            E !== !1 && (a.width = E + (z ? 0 : m + _));
            var x = t(r.height);
            return x !== !1 && (a.height = x + (z ? 0 : g + b)), a.innerWidth = a.width - (m + _), a.innerHeight = a.height - (g + b), a.outerWidth = a.width + y, a.outerHeight = a.height + v, a
        }
    }
...
function(t, e) {
    ...
    return i.compatOptions.fitWidth = "isFitWidth", i.prototype._resetLayout = function() {
        ...
        for (var o = this._getColGroup(n), r = Math.min.apply(Math, o), s = o.indexOf(r), a = {
                ...
                y: r
            }, u = r + t.size.outerHeight, h = this.cols + 1 - o.length, d = 0; d < h; d++) this.colYs[s + d] = u;
        return a
        ...
        for (var h = this._getOption("originTop"), d = (h ? n.top : n.bottom) + i.outerHeight, c = a; c <= u; c++) this.colYs[c] = Math.max(d, this.colYs[c])
...
var eb = function(t) {
    function e() {
        t(window).load(function() {
            i(), t(".js-posts").masonry({
                itemSelector: ".post-wrapper"
            })
        }), t(window).resize(function() {
            i()
        }), t(document).ready(function() {
            t(".js-lazyload").unveil()
            ...
            return t(this).addClass("cta--progress"), n(function() {
                t(this).removeClass("cta--progress")
            }.bind(this)), r("Articles", "Load more"), !1
    ...
    function n(e) {
        ...
        r > n || (r == n && o(), t.get("/page/" + r + "/", function(i) {
            ...
            c.find(".js-posts").append(o).masonry("appended", o), c.attr("data-paginator-current", r), e()
        }))
    }
    ...
    function s(e) {
        ...
        t("#main").append(i), setTimeout(function() {
            a()
        }, 5e3)
    }
    ...
    function u() {
        e(), window.SimpleJekyllSearch ? h() : window.SimpleJekyllSearchInit = h, d()
    }

    function h() {
        var t = "";
        t += '<a href="{url}" class="search-result small-card">', t += ' <p class="small-card__pre">{date}</p>', t += ' <p class="small-card__title">{title}</p>', t += "</a>", SimpleJekyllSearch({
    ...
    function d() {
        ...
        n.click(a), o.click(a), e.on("ended", function() {
            s(!1)
        })
    }
    var c = t("#main");
